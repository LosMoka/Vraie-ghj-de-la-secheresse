    ...
    public class ElementsStore : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            if (gameManagerGameObject == null)
            {
                ...
                m_environmentStore.devOnlyAddMapTrap(mapAssetsManager.getMapTrapByName("TimerSprite"));
                m_environmentStore.devOnlyAddMapTrap(mapAssetsManager.getMapTrapByName("GlissadeSprite"));
                m_environmentStore.devOnlyAddMapTrap(mapAssetsManager.getMapTrapByName("NegatifSprite"));
                m_environmentStore.devOnlyAddMapTrap(mapAssetsManager.getMapTrapByName("NoirBlancSprite"));
                m_environmentStore.devOnlyAddMapTrap(mapAssetsManager.getMapTrapByName("SlowSprite"));
                m_environmentStore.devOnlyAddMapTrap(mapAssetsManager.getMapTrapByName("VisionSprite"));
